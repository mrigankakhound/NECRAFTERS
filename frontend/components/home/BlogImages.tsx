  ...
  return (
    <div className="w-full overflow-hidden bg-white py-8">
      ...
      <div className="text-center mb-9">
        <h2 className="text-2xl font-bold tracking-wide font-capriola bg-gradient-to-r from-orange-600 via-red-600 to-orange-600 bg-clip-text text-transparent">
      ...
      <div className="mb-4 overflow-hidden">
        <div className="flex animate-scroll-left gap-[5px]">
          ...
          <div className="flex flex-shrink-0 gap-[5px]">
            ...
            />
            <img
              src="/images/photoboot/img3.jpg"
              alt="Blog image 3"
              className="w-64 h-64 object-cover"
            />
            <img
              src="/images/photoboot/img4.jpg"
              alt="Blog image 4"
              className="w-64 h-64 object-cover"
            />
            <img
              src="/images/photoboot/img5.jpg"
              alt="Blog image 5"
              className="w-64 h-64 object-cover"
            />
            <img
      ...
      <div className="overflow-hidden">
        <div className="flex animate-scroll-right gap-[5px]">
          ...
          <div className="flex flex-shrink-0 gap-[5px]">
            ...
            />
            <img
              src="/images/photoboot/img7.jpg"
              alt="Blog image 7"
              className="w-64 h-64 object-cover"
            />
            <img
              src="/images/photoboot/img8.jpg"
              alt="Blog image 8"
              className="w-64 h-64 object-cover"
            />
            <img
              src="/images/photoboot/img9.jpg"
              alt="Blog image 9"
              className="w-64 h-64 object-cover"
            />
            <img
              src="/images/photoboot/img10.jpg"
              alt="Blog image 10"
              className="w-64 h-64 object-cover"
            />
            <img
              src="/images/photoboot/img13.jpg"
              alt="Blog image 10"
              className="w-64 h-64 object-cover"
            />
            <img
              src="/images/photoboot/img14.jpg"
              alt="Blog image 10"
              className="w-64 h-64 object-cover"
            />
          </div>
