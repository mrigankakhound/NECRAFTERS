...
const NeedOfWebsite = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-16">
              <h2 className="text-3xl font-bold sm:text-4xl lg:text-5xl text-center w-full py-6 sm:py-8 lg:py-10 uppercase font-capriola bg-gradient-to-r from-orange-600 via-red-600 to-orange-600 bg-clip-text text-transparent">WHY NE CRAFTERS?</h2>
