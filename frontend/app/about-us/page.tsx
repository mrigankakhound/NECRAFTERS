...
export default function AboutUsPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-primary/5 to-accent/5 py-20">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center space-y-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/20">
              <p className="text-xl text-[#5f6b7b] leading-relaxed text-justify mb-6">
              ...
              <div className="bg-gradient-to-r from-primary/10 to-accent/10 rounded-2xl p-6 border border-primary/20">
                <p className="text-lg text-[#5f6b7b] text-center font-medium">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="relative group">
                <div className="relative aspect-[4/3] w-full">
                  <div className="absolute inset-0 rounded-[2rem] overflow-hidden shadow-2xl transform group-hover:scale-105 transition-transform duration-500" 
                    style={{
                  ...
                  <div className="absolute -z-10 -bottom-8 -right-8 w-full h-full rounded-[2rem] bg-gradient-to-br from-primary/20 to-accent/20 blur-2xl group-hover:blur-3xl transition-all duration-500"></div>
                  {/* Floating badge */}
                  <div className="absolute -top-4 -left-4 bg-gradient-to-r from-primary to-accent text-white px-4 py-2 rounded-full text-sm font-semibold shadow-lg">
                    Our Mission
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
                  <div className="flex items-center space-x-3 p-4 bg-gradient-to-r from-primary/5 to-transparent rounded-xl">
                    <div className="w-8 h-8 bg-primary rounded-full flex items-center justify-center">
                      <span className="text-white text-sm">🌶️</span>
                    </div>
                    <span className="text-sm font-medium text-[#5f6b7b]">Authentic Flavors</span>
                  </div>
                  <div className="flex items-center space-x-3 p-4 bg-gradient-to-r from-accent/5 to-transparent rounded-xl">
                    <div className="w-8 h-8 bg-accent rounded-full flex items-center justify-center">
                      <span className="text-white text-sm">🌱</span>
                    </div>
                    <span className="text-sm font-medium text-[#5f6b7b]">Sustainable</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-center space-x-4 mt-8">
                  ...
                  <span className="text-sm text-accent font-medium">Our Growth Journey</span>
                </div>
              </div>
              ...
              <div className="relative group">
                <div className="relative aspect-[4/3] w-full">
                  ...
                  {/* Enhanced decorative background blur */}
                  <div className="absolute -z-10 -bottom-8 -left-8 w-full h-full rounded-[2rem] bg-gradient-to-br from-accent/20 to-primary/20 blur-2xl group-hover:blur-3xl transition-all duration-500"></div>
                  {/* Floating badge */}
                  <div className="absolute -top-4 -right-4 bg-gradient-to-r from-accent to-primary text-white px-4 py-2 rounded-full text-sm font-semibold shadow-lg">
                    Our Story
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 gap-4 mt-8">
                  <div className="text-center p-4 bg-gradient-to-br from-primary/10 to-transparent rounded-xl border border-primary/20">
                    ...
                    <div className="text-sm text-[#5f6b7b]">Farmer Direct</div>
                  </div>
                  <div className="text-center p-4 bg-gradient-to-br from-accent/10 to-transparent rounded-xl border border-accent/20">
                    <div className="text-2xl font-bold text-accent">Carbon</div>
                    <div className="text-sm text-[#5f6b7b]">Negative Goal</div>
                  </div>
                </div>
              </div>
            </div>
